...
@else
  ...
  <form method="get" action="/main/createiso" style="margin-top: 5rem;">
  
  <div class="form-row">
    <div class="form-group col-md-3">
      <label for="inputEmail4">SO</label>
      <select id="inputState" class="form-control" name="SO">
  ...
  <input type="submit" class="btn btn-primary btn-lg" value="Crear" name="Crear ISO">
